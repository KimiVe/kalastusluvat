...
const Homepage = () => {
    ...
    return (
        <>
            <div id="etusivu" className="info-section">
                <div className="content-container">
                    <div className="content-box text-content">
                        <h1 className="content-header">{textContent.frontPage.text0Header}</h1>
                        <p className="content-text">{textContent.frontPage.text0Content}</p>
                    </div>
                </div>
            </div>
            <div id="kalastonhoito-maksu" className="info-section">
                <div className="content-container">
                    <div className="content-box text-content">
                        <h2 className="content-header">{textContent.frontPage.text1Header}</h2>
